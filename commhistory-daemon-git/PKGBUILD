...
license=('LGPLv2')
depends=('qt5-base' 'libcommhistory-git' 'qt5-contacts-sqlite-extensions-git' 'qt5-mlite-git' 'qt5-mce-git' 'qt5-mlocale-git' 'telepathy-qt' 'libqofono-qt5' 'qt5-ngfd-git' 'mapplauncherd-qt-git')
makedepends=('git')
