...
have+="telepathy-qt telepathy-glib telepathy-ofono libpulse pulseaudio python openssl bluez-qt kcalendarcore maliit-framework qt5-xmlpatterns dconf libarchive "
