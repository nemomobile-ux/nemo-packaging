...
pkgver=4.0.4+git136
pkgrel=2
pkgdesc="Qt Messaging Framework (QMF) qt6"
arch=('x86_64' 'aarch64')
...
depends=('nemo-keepalive'
    ...
    'libaccounts-qt6'
    'signond6')
makedepends=('git' 'qt6-old-features')
...
sha256sums=('844e7232cb8520e38a6cacd4e6e0cfdb0584641daee096f6741b803b4737fdd9'
    ...
    'df4fb25e6bf7727ace4fa9abbc104549fefe00b4388a5b2f62732ee3059f7cc4'
...
prepare() {
  ...
  patch -p1 --input="${srcdir}/0093-qt5-qt6.patch"
